<template>
  <div>
    ...
    <div class="flex justify-center mx-auto flex px-1 py-8">
      ...
      >
        <img class="p-4 w-24 h-24" src="../assets/steps/tap.svg" alt="" />
      </div>
      <div
        class="choiceDiv"
      ...
      >
        <img class="p-4 h-24 w-24" src="../assets/steps/source.svg" alt="" />
      </div>
    </div>
    <div class="flex justify-center mx-auto flex px-5 py-8">
      <a @click.prevent="goToStep(1, true)" ref="previous" href="/"
        ><img class="steparr w-16" src="../assets/previous.svg" alt="previous"
      /></a>
      <a
        @click.prevent="goToStep(3, false)"
...
export default {
  ...
  created() {
    if (
      Object.keys(this.choice).length > 2 &&
      this.choice.constructor === Object
    ) {
      this.activeTab = Object.values(this.choice)[1] ? 1 : 2
    }
  },
  data() {
    return {
